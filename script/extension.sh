...
windows_spary_password="$HOME/oscp-swiss/utils/windows/Spray-Passwords.ps1"
windows_PE_rubeus="$HOME/oscp-swiss/utils/windows/Rubeus.exe"
windows_bloodhound_4_3_1="$HOME/oscp-swiss/utils/windows/BloodHoundCollector-4.3.1"
